...
export const metadata: Metadata = {
  title: { default: "Hatake Social", template: "%s | Hatake Social" },
  description: "The premier trading card game community. Collect, trade, and connect.",
  manifest: "/manifest.json",
  appleWebApp: { capable: true, statusBarStyle: "black-translucent", title: "Hatake" },
  formatDetection: { telephone: false },
  openGraph: { title: "Hatake Social", description: "The premier trading card game community.", siteName: "Hatake Social", locale: "en_US", type: "website" },
};
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${syne.variable} ${inter.variable} antialiased bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col`}>
        <ThemeProvider>
