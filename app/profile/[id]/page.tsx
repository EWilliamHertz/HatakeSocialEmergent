  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="flex items-start justify-between -mt-12">
              ...
              {!isOwnProfile && (
                <div className="flex gap-2 pt-14">
                  ...
                  <Link href={user ? `/collection/user/${user.user_id}` : '#'}>
                    <button className="flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition">
                      📚 View Collection
                    </button>
                  </Link>
                  {isFriend ? (
        ...
        {/* Badges */}
        {badges.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-6" data-testid="user-badges">
