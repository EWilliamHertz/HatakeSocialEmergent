                          ...
                          {msg.attachments && msg.attachments.length > 0 && (
                            <div className="flex flex-col gap-2 mt-2">
                              {msg.attachments.map((att) => (
                                <div key={att.url} className="max-w-xs rounded-lg overflow-hidden">
                                  <img src={att.url} alt="Message attachment" className="w-full h-auto object-cover rounded-lg" />
                                </div>
                              ))}
                            </div>
                          )}
                          <div className={`${msg.sender_id === currentUserId ? 'bg-blue-600 text-white' : 'bg-gray-100'} rounded-xl px-3 py-2`}>
